...
# 
yum install zlib-devel bzip2-devel ncurses-devel sqlite-devel readline-devel tk-devel expat-devel gdbm-devel xz-devel wget db4-devel libpcap-devel libffi-devel
# 编译环境
...
```zsh
./configure --prefix=/home/centos/deployment/Python3.8.5 --enable-optimizations
make build_all
make install
```
